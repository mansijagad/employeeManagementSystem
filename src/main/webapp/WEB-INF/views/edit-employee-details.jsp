			...
			<form action="updateEmployee" method="post">
				...
				<b>
					<label for="text">Id :</label> <input type="text"
						class="input" name="empId" value="${employee.empId}" readonly="readonly" />
				</b>
				</div>
				...
				<input class = "radioBtn" type = "radio" id="yes" name = "isAdmin" value = "${employee.isAdmin}">
				<label class = "radiobtn-Label" for = "yes">Yes</label>
				<input class = "radioBtn" type = "radio" id="no" name = "isAdmin" value = "${employee.isAdmin }">
